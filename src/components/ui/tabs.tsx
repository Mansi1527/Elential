  ...
  return (
    <div className="flex flex-col md:flex-row gap-10 text-black">
      ...
      >
        {propTabs.map((tab, idx) => (
          <button
            ...
            className={cn("relative px-4 py-4 rounded-xl text-center flex justify-center items-center ", tabClassName)}
            style={{
          ...
          >
            {active.value === tab.value && (
              <motion.div
                ...
                className={cn(
                  "absolute inset-0 bg-gray-200 text-black  rounded-xl ",
                  activeTabClassName
                )}
              />
            )}
      ...
      <FadeInDiv
        ...
        key={active.value}
        hovering={hovering}
        className={cn("md:mt-20 mt- px-10", contentClassName)}
      />
