...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[28rem] md:h-[60rem] flex items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
      <div
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        scale,
        boxShadow:
          "0 0 #0000004d, 0 9px 20px #0000004a, 0 37px 37px #00000042, 0 54px 30px #00000026, 0 89px 40px #0000000a, 0 113px 45px #00000003",
      }}
