...
export const MacbookScroll = ({
  ...
  return (
    ...
    <div
      ref={ref}
      className="md:min-h-[200vh]  w-2/3   flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
    ...
    {/* text */}
    {/* <div className="about-text lg:w-3/2 text-center lg:text-left mt-40 lg:mt-40">
                  <h1 className="text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-gray-500 via-black to-black text-transparent bg-clip-text">
                      We Build Stunning Websites 🚀
                  </h1>
                  <p className="mt-4 text-lg text-gray-700 leading-relaxed">
                      At <span className="font-semibold">Company</span>, we specialize in building <b>fast, responsive, and user-friendly</b> websites.
                      Our team of experts blends <b>creativity with the latest technology</b> to deliver high-quality web solutions.
                  </p>
                  <p className="mt-3 text-lg text-gray-600 italic">
                      We’re here to turn your <b>vision into reality</b>.
                  </p>
                  <a href="/contact" className="mt-6 text-2xl font-semibold bg-gradient-to-r from-blue-500 to-purple-500 text-transparent bg-clip-text">
...
const AceternityLogo = () => {
  return (
    ...
    // < Image src="/program.png" alt={""} width={200} height={200}/>
